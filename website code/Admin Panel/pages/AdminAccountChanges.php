...
<body>
        ...
        <form class="splash-container mx-auto ml-5" action="AdminAccountPHP.php" method="POST">
            <div class="card text-center">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <input class="form-control form-control-lg" id="pass1" type="password" name="currntpass" required="" placeholder="Current Password">
                    </div>
                    <div class="form-group">
                        <input class="form-control form-control-lg" id="pass1" type="password" name="newpass" required="" placeholder="New Password">
                    </div>
                    <small class="text-danger"> <?php  if(isset($_SESSION["incorrectMsg"])) 
                                      {echo $_SESSION["incorrectMsg"];
                                      session_unset();
                                      session_destroy();} ?>
                    </small>
                    ...
                    <div class="form-group">
                        <label class="custom-control custom-checkbox">
                            <input class="custom-control-input" type="checkbox"><span class="custom-control-label">By changing an account's info, you agree the <a href="#">terms and conditions</a></span>
                        </label>
                    </div>
                    <div class="form-group pt-2">
                        <button class="btn btn-block btn-primary" type="submit" name="changes">Save Changes</button>
                    </div>
                  
                    <div class="form-group mt-3">
                        <a href="AdminAccount.php" class="text-primary">Create New Account </a>
                    </div>
    ...
    <?php  if(isset($_SESSION["correctMsg"])) 
                                     { 
                                        echo '<script language="javascript">';
                                        echo 'alert("New account has been created successfully")';
                                        echo '</script>';
                                        session_unset();
                                        session_destroy();
                                      } ?>
