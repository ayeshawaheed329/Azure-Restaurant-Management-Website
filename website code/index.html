...
<!DOCTYPE html>
  ...
  <!-- Facebook and Twitter integration -->
	...
	<div id="colorlib-page">
				   			...
				   			<div class="col-md-6 col-sm-12 col-xs-12 col-md-offset-3 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<div class="desc">
					   					...
					   					<p>Bringing you scrumptious foods from the best of Italy and Pakistan. The food is bound to leave you wanting more.</p>
				   			...
				   			<div class="col-md-6 col-sm-12 col-xs-12 col-md-offset-3 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<div class="desc">
					   					...
					   					<p>The chef, renowned for all his specials, has travelled all over the world to find the best for you.</p>
			   			...
			   			<div class="row">
				   			<div class="col-md-6 col-sm-12 col-xs-12 col-md-offset-3 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<div class="desc">
				   						<span class="icon"><i class="flaticon-cutlery"></i></span>
					   					<h1>Exquisiteness awaits you!</h1>
					   					<p>At Azure, the word 'basic' is just not known. Everything, from the drinks and the apetizers to the entrees are beyond delicious.</p>
					   					<p><a href="#" class="btn btn-primary btn-lg btn-learn">Book a table</a></p>
					   					<div class="desc2"></div>
					   				</div>
				   				</div>
				   			...
				   			<div class="col-md-6 col-sm-12 col-xs-12 col-md-offset-3 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<div class="desc">
				   						<span class="icon"><i class="flaticon-cutlery"></i></span>
					   					<h1>Book a table</h1>
					   					<p>Giving you a chance to book a table from anywhere. Choose a suitable date and time, and you will be good to go.</p>
					   					<p><a href="#" class="btn btn-primary btn-lg btn-learn">Book a table</a></p>
					   					<div class="desc2"></div>
					   				</div>
				   				</div>
				...
				<div class="row">
					...
					<div class="col-md-3 col-sm-6 text-center">
						<div class="intro animate-box">
							...
							<h2>Email</h2>
							<p><a href="#">k173879@nu.edu.pk</a><br><a href="#">k173897@nu.edu.pk</a></p>
						</div>
					</div>
				</div>
			</div>
						...
						<div class="row">
							<div class="about-desc">
								<div class="col-md-12 col-md-offset-0 animate-box intro-heading">
									...
									<h2>Providing succulent food since 1895</h2>
								</div>
								<div class="col-md-12 animate-box">
									<p>Tantalize your tastebuds with delectable, mouthwatering food here, all the way from Italy and Pakistan</p>
								</div>
							</div>
						</div>
					</div>
		...
		<div class="colorlib-introduction mb-5" style="background-image: url(images/videobg.jpg);" data-stellar-background-ratio="0.5">
			<div class="overlay"></div>
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3 col-md-push-3">
						<div class="intro-box animate-box">
							...
							<p>You will never find anything as good as the food you taste at Azure. We serve perfectness every single time.</p>
							<p><a href="https://www.youtube.com/watch?v=7EdpBH81XIY" class="btn btn-primary btn-lg btn-outline popup-vimeo"><i class="icon-play3"></i> Watch Video</a></p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="colorlib-testimony " style="background-image: url(images/cover_bg_2.jpg); margin-top:200px" data-stellar-background-ratio="0.5">
			<div class="overlay "></div>
			<div class="container ">
				<div class="row">
					...
					<div class="owl-carousel">
						...
						<div class="item">
							<div class="col-md-8 col-md-offset-2 text-center">
								<div class="testimony">
									<blockquote>
										<p>"Brace yourself for the rollercoaster your mouth is going to experience. Every item on the menu speaks for itself.</p>
					...
					<div class="row">
						<div class="col-md-12 animate-box">
							<div class="row">
								<div class="col-md-12 text-center">
									<ul class="nav nav-tabs text-center" role="tablist">
										<li role="presentation" class="active"><a href="#main" aria-controls="mains" role="tab" data-toggle="tab">Pakistani / Italian</a></li>
							...
							<div class="col-md-12 animate-box text-center">
								...
								<p><a href="menu.php" class="btn btn-primary btn-outline btn-md">Place Order</a></p>
							</div>	
						</div>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						<div class="row">
							<div class="col-md-12">
								<form  action = "rev.php" method="post" class="colorlib-form">
				              	<div class="row">
										...
										<div class="col-md-6 animate-box">
											...
											<div class="col-md-12 animate-box">
												<div class="form-group">
														<label for="email">Type Below</label>
														<div class="form-field">
													<textarea rows="4" cols="100" class="text-center form-control" name="msg" >
														</textarea>
													</div>
												</div>
											</div>
